...
var require_react_development = __commonJS({
    ...
    in`) === 0
			...
			function traverseAllChildrenImpl(children, nameSoFar, callback, traverseContext) {
				...
				if (invokeCallback)
					return callback(traverseContext, children, nameSoFar === '' ? SEPARATOR + getComponentKey(children, 0) : nameSoFar), 1
				var child,
					nextName,
					subtreeCount = 0,
  ...
  const MyComponent = lazy(() => import('./MyComponent'))`,
			...
			function updateNamedCousins(rootNode, props) {
				...
				if (props.type === 'radio' && name != null) {
					...
					for (
						var group = queryRoot.querySelectorAll('input[name=' + JSON.stringify('' + name) + '][type="radio"]'), i = 0;
						i < group.length;
						i++
					) {
			...
			var warnValidStyle = function () {}
			{
				...
				warnValidStyle = function (name, value) {
					name.indexOf('-') > -1
						...
						typeof value == 'number' &&
							(isNaN(value) ? warnStyleValueIsNaN(name, value) : isFinite(value) || warnStyleValueIsInfinity(name, value))
				}
			}
...
`
			...
			function setInitialProperties(domElement, tag, rawProps, rootContainerElement) {
				...
				switch (
					(assertValidProps(tag, props), setInitialDOMProperties(tag, domElement, rootContainerElement, props, isCustomComponentTag), tag)
				) {
					case 'input':
			...
			function getInstanceFromNode$1(node2) {
				...
				return inst && (inst.tag === HostComponent || inst.tag === HostText || inst.tag === SuspenseComponent || inst.tag === HostRoot)
					? inst
					: null
			}
...
Incoming: %s`,
				...
				InvalidNestedHooksDispatcherOnRerenderInDEV = null
			{
				...
				;(HooksDispatcherOnMountInDEV = {
					...
					(InvalidNestedHooksDispatcherOnUpdateInDEV = {
						...
						useCallback: function (callback, deps) {
							return (
								(currentHookNameInDev = 'useCallback'), warnInvalidHookAccess(), updateHookTypesDev(), updateCallback(callback, deps)
							)
						},
						useContext: function (context, observedBits) {
							return (
			...
			function updateMemoComponent(current2, workInProgress2, Component, nextProps, updateExpirationTime, renderExpirationTime2) {
				...
				if (updateExpirationTime < renderExpirationTime2) {
					...
					if (
						((compare = compare !== null ? compare : shallowEqual), compare(prevProps, nextProps) && current2.ref === workInProgress2.ref)
					)
			...
			function updateClassComponent(current2, workInProgress2, Component, nextProps, renderExpirationTime2) {
				...
				instance === null
					? (current2 !== null &&
							((current2.alternate = null), (workInProgress2.alternate = null), (workInProgress2.effectTag |= Placement)),
				...
				switch (((workInProgress2.expirationTime = NoWork), workInProgress2.tag)) {
					...
					case FunctionComponent: {
						var _Component = workInProgress2.type,
							...
							resolvedProps =
								workInProgress2.elementType === _Component ? unresolvedProps : resolveDefaultProps(_Component, unresolvedProps)
					...
					case ClassComponent: {
						var _Component2 = workInProgress2.type,
							...
							_resolvedProps =
								workInProgress2.elementType === _Component2 ? _unresolvedProps : resolveDefaultProps(_Component2, _unresolvedProps)
					...
					case IncompleteClassComponent: {
						var _Component3 = workInProgress2.type,
							...
							_resolvedProps4 =
								workInProgress2.elementType === _Component3 ? _unresolvedProps4 : resolveDefaultProps(_Component3, _unresolvedProps4)
	...
	switch (typeof interpolation) {
		...
		case 'object': {
			...
			if (interpolation.styles !== void 0) {
				...
				if (next2 !== void 0)
					for (; next2 !== void 0; ) (cursor = { name: next2.name, styles: next2.styles, next: cursor }), (next2 = next2.next)
		...
		return function () {
			...
			var Styled = withEmotionCache(function (props, cache, ref) {
				...
				var finalShouldForwardProp =
						shouldUseAs && shouldForwardProp === void 0 ? getDefaultShouldForwardProp(FinalTag) : defaultShouldForwardProp,
					newProps = {}
