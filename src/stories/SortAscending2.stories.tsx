import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortAscending2 from '../icons-test/sort-ascending-2'
    
    const meta: Meta<typeof SortAscending2> = {
        component: SortAscending2,
        title: 'outline/SortAscending2',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortAscending2>
