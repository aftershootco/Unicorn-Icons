import type { Meta, StoryObj } from '@storybook/react'
    ...
    import LoupeFillIcon from '../icons/loupe-fill-icon'
    
    const meta: Meta<typeof LoupeFillIcon> = {
        component: LoupeFillIcon,
        title: 'fill/LoupeFillIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof LoupeFillIcon>
