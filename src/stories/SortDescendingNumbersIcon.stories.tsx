import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortDescendingNumbersIcon from '../icons/sort-descending-numbers-icon'
    
    const meta: Meta<typeof SortDescendingNumbersIcon> = {
        component: SortDescendingNumbersIcon,
        title: 'outline/SortDescendingNumbersIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortDescendingNumbersIcon>
