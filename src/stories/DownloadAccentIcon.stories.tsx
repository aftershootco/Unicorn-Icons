import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DownloadAccentIcon from '../icons/download-accent-icon'
    
    const meta: Meta<typeof DownloadAccentIcon> = {
        component: DownloadAccentIcon,
        title: 'accent/DownloadAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DownloadAccentIcon>
