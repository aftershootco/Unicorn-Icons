import type { Meta, StoryObj } from '@storybook/react'
    ...
    import MoodEmptyIcon from '../icons/mood-empty-icon'
    
    const meta: Meta<typeof MoodEmptyIcon> = {
        component: MoodEmptyIcon,
        title: 'outline/MoodEmptyIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof MoodEmptyIcon>
