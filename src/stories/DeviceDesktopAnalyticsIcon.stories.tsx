import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DeviceDesktopAnalyticsIcon from '../icons/device-desktop-analytics-icon'
    
    const meta: Meta<typeof DeviceDesktopAnalyticsIcon> = {
        component: DeviceDesktopAnalyticsIcon,
        title: 'outline/DeviceDesktopAnalyticsIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DeviceDesktopAnalyticsIcon>
