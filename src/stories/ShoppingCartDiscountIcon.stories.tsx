import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ShoppingCartDiscountIcon from '../icons/shopping-cart-discount-icon'
    
    const meta: Meta<typeof ShoppingCartDiscountIcon> = {
        component: ShoppingCartDiscountIcon,
        title: 'outline/ShoppingCartDiscountIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ShoppingCartDiscountIcon>
