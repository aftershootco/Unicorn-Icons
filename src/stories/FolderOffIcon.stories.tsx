import type { Meta, StoryObj } from '@storybook/react'
    ...
    import FolderOffIcon from '../icons/folder-off-icon'
    
    const meta: Meta<typeof FolderOffIcon> = {
        component: FolderOffIcon,
        title: 'outline/FolderOffIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof FolderOffIcon>
