import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AdjustmentsHorizontalIcon from '../icons/adjustments-horizontal-icon'
    
    const meta: Meta<typeof AdjustmentsHorizontalIcon> = {
        component: AdjustmentsHorizontalIcon,
        title: 'outline/AdjustmentsHorizontalIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AdjustmentsHorizontalIcon>
