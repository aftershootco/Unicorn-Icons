import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ColorSwatchIcon from '../icons/color-swatch-icon'
    
    const meta: Meta<typeof ColorSwatchIcon> = {
        component: ColorSwatchIcon,
        title: 'outline/ColorSwatchIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ColorSwatchIcon>
