import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ArrowCurveFillIcon from '../icons/arrow-curve-fill-icon'
    
    const meta: Meta<typeof ArrowCurveFillIcon> = {
        component: ArrowCurveFillIcon,
        title: 'fill/ArrowCurveFillIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowCurveFillIcon>
