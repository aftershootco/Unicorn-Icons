import type { Meta, StoryObj } from '@storybook/react'
    ...
    import PhotoOff2Icon from '../icons/photo-off-2-icon'
    
    const meta: Meta<typeof PhotoOff2Icon> = {
        component: PhotoOff2Icon,
        title: 'outline/PhotoOff2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof PhotoOff2Icon>
