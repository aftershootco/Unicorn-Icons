import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ListFillIcon from '../icons/list-fill-icon'
    
    const meta: Meta<typeof ListFillIcon> = {
        component: ListFillIcon,
        title: 'fill/ListFillIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ListFillIcon>
