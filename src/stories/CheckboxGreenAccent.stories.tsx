import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CheckboxGreenAccent from '../icons-test/checkbox-green-accent'
    
    const meta: Meta<typeof CheckboxGreenAccent> = {
        component: CheckboxGreenAccent,
        title: 'accent/CheckboxGreenAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CheckboxGreenAccent>
