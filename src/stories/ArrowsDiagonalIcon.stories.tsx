import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ArrowsDiagonalIcon from '../icons/arrows-diagonal-icon'
    
    const meta: Meta<typeof ArrowsDiagonalIcon> = {
        component: ArrowsDiagonalIcon,
        title: 'outline/ArrowsDiagonalIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowsDiagonalIcon>
