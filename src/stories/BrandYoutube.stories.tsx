import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandYoutube from '../icons-test/brand-youtube'
    
    const meta: Meta<typeof BrandYoutube> = {
        component: BrandYoutube,
        title: 'outline/BrandYoutube',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandYoutube>
