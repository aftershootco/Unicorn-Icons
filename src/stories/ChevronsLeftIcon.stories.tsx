import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ChevronsLeftIcon from '../icons/chevrons-left-icon'
    
    const meta: Meta<typeof ChevronsLeftIcon> = {
        component: ChevronsLeftIcon,
        title: 'outline/ChevronsLeftIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ChevronsLeftIcon>
