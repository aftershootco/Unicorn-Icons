import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortDescendingLettersIcon from '../icons/sort-descending-letters-icon'
    
    const meta: Meta<typeof SortDescendingLettersIcon> = {
        component: SortDescendingLettersIcon,
        title: 'outline/SortDescendingLettersIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortDescendingLettersIcon>
