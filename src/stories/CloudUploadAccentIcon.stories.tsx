import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CloudUploadAccentIcon from '../icons/cloud-upload-accent-icon'
    
    const meta: Meta<typeof CloudUploadAccentIcon> = {
        component: CloudUploadAccentIcon,
        title: 'accent/CloudUploadAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CloudUploadAccentIcon>
