import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortDescending2 from '../icons-test/sort-descending-2'
    
    const meta: Meta<typeof SortDescending2> = {
        component: SortDescending2,
        title: 'outline/SortDescending2',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortDescending2>
