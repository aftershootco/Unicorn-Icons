import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CheckboxGreenAccentIcon from '../icons/checkbox-green-accent-icon'
    
    const meta: Meta<typeof CheckboxGreenAccentIcon> = {
        component: CheckboxGreenAccentIcon,
        title: 'accent/CheckboxGreenAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CheckboxGreenAccentIcon>
