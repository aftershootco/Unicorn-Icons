import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DeviceDesktopOffIcon from '../icons/device-desktop-off-icon'
    
    const meta: Meta<typeof DeviceDesktopOffIcon> = {
        component: DeviceDesktopOffIcon,
        title: 'outline/DeviceDesktopOffIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DeviceDesktopOffIcon>
