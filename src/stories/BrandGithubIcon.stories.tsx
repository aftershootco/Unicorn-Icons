import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandGithubIcon from '../icons/brand-github-icon'
    
    const meta: Meta<typeof BrandGithubIcon> = {
        component: BrandGithubIcon,
        title: 'outline/BrandGithubIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandGithubIcon>
