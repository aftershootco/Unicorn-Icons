import type { Meta, StoryObj } from '@storybook/react'
    ...
    import LayoutSidebarRightMix from '../icons-test/layout-sidebar-right-mix'
    
    const meta: Meta<typeof LayoutSidebarRightMix> = {
        component: LayoutSidebarRightMix,
        title: 'no-change/LayoutSidebarRightMix',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof LayoutSidebarRightMix>
