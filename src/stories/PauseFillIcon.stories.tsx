import type { Meta, StoryObj } from '@storybook/react'
    ...
    import PauseFillIcon from '../icons/pause-fill-icon'
    
    const meta: Meta<typeof PauseFillIcon> = {
        component: PauseFillIcon,
        title: 'fill/PauseFillIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof PauseFillIcon>
