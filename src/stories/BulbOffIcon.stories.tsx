import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BulbOffIcon from '../icons/bulb-off-icon'
    
    const meta: Meta<typeof BulbOffIcon> = {
        component: BulbOffIcon,
        title: 'outline/BulbOffIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BulbOffIcon>
