import type { Meta, StoryObj } from '@storybook/react'
    ...
    import StarFillOff from '../icons-test/star-fill-off'
    
    const meta: Meta<typeof StarFillOff> = {
        component: StarFillOff,
        title: 'no-change/StarFillOff',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof StarFillOff>
