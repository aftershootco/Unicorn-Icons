import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CheckboxBlueAccent from '../icons-test/checkbox-blue-accent'
    
    const meta: Meta<typeof CheckboxBlueAccent> = {
        component: CheckboxBlueAccent,
        title: 'accent/CheckboxBlueAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CheckboxBlueAccent>
