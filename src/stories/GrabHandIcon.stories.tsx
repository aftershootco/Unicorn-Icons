import type { Meta, StoryObj } from '@storybook/react'
    ...
    import GrabHandIcon from '../icons/grab-hand-icon'
    
    const meta: Meta<typeof GrabHandIcon> = {
        component: GrabHandIcon,
        title: 'logo/GrabHandIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof GrabHandIcon>
