import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CrownFillIcon from '../icons/crown-fill-icon'
    
    const meta: Meta<typeof CrownFillIcon> = {
        component: CrownFillIcon,
        title: 'fill/CrownFillIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CrownFillIcon>
