import type { Meta, StoryObj } from '@storybook/react'
    ...
    import PhotoStackIcon from '../icons/photo-stack-icon'
    
    const meta: Meta<typeof PhotoStackIcon> = {
        component: PhotoStackIcon,
        title: 'outline/PhotoStackIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof PhotoStackIcon>
