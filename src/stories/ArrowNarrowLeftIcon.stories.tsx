import type { Meta, StoryObj } from '@storybook/react'
    ...
    const meta: Meta<typeof ArrowNarrowLeftIcon> = {
        component: ArrowNarrowLeftIcon,
        title: 'outline/ArrowNarrowLeftIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowNarrowLeftIcon>
