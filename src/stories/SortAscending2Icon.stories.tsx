import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortAscending2Icon from '../icons/sort-ascending-2-icon'
    
    const meta: Meta<typeof SortAscending2Icon> = {
        component: SortAscending2Icon,
        title: 'outline/SortAscending2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortAscending2Icon>
