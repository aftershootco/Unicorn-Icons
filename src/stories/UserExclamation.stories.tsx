import type { Meta, StoryObj } from '@storybook/react'
    ...
    import UserExclamation from '../icons-test/user-exclamation'
    
    const meta: Meta<typeof UserExclamation> = {
        component: UserExclamation,
        title: 'outline/UserExclamation',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof UserExclamation>
