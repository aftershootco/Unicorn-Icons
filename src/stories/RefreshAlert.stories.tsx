import type { Meta, StoryObj } from '@storybook/react'
    ...
    import RefreshAlert from '../icons-test/refresh-alert'
    
    const meta: Meta<typeof RefreshAlert> = {
        component: RefreshAlert,
        title: 'outline/RefreshAlert',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof RefreshAlert>
