import type { Meta, StoryObj } from '@storybook/react'
    ...
    import MoodCrazyHappy from '../icons-test/mood-crazy-happy'
    
    const meta: Meta<typeof MoodCrazyHappy> = {
        component: MoodCrazyHappy,
        title: 'outline/MoodCrazyHappy',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof MoodCrazyHappy>
