import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortAscending from '../icons-test/sort-ascending'
    
    const meta: Meta<typeof SortAscending> = {
        component: SortAscending,
        title: 'outline/SortAscending',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortAscending>
