import type { Meta, StoryObj } from '@storybook/react'
    ...
    import FolderUploadIcon from '../icons/folder-upload-icon'
    
    const meta: Meta<typeof FolderUploadIcon> = {
        component: FolderUploadIcon,
        title: 'outline/FolderUploadIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof FolderUploadIcon>
