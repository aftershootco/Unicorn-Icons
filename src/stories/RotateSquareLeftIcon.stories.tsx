import type { Meta, StoryObj } from '@storybook/react'
    ...
    import RotateSquareLeftIcon from '../icons/rotate-square-left-icon'
    
    const meta: Meta<typeof RotateSquareLeftIcon> = {
        component: RotateSquareLeftIcon,
        title: 'outline/RotateSquareLeftIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof RotateSquareLeftIcon>
