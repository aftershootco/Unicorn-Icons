import type { Meta, StoryObj } from '@storybook/react'
    ...
    const meta: Meta<typeof ArrowNarrowRightIcon> = {
        component: ArrowNarrowRightIcon,
        title: 'outline/ArrowNarrowRightIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowNarrowRightIcon>
