import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortDescendingNumbers from '../icons-test/sort-descending-numbers'
    
    const meta: Meta<typeof SortDescendingNumbers> = {
        component: SortDescendingNumbers,
        title: 'outline/SortDescendingNumbers',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortDescendingNumbers>
