import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandWhatsappIcon from '../icons/brand-whatsapp-icon'
    
    const meta: Meta<typeof BrandWhatsappIcon> = {
        component: BrandWhatsappIcon,
        title: 'outline/BrandWhatsappIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandWhatsappIcon>
