import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortDescending from '../icons-test/sort-descending'
    
    const meta: Meta<typeof SortDescending> = {
        component: SortDescending,
        title: 'outline/SortDescending',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortDescending>
