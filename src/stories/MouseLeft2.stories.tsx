import type { Meta, StoryObj } from '@storybook/react'
    ...
    import MouseLeft2 from '../icons-test/mouse-left-2'
    
    const meta: Meta<typeof MouseLeft2> = {
        component: MouseLeft2,
        title: 'no-change/MouseLeft2',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof MouseLeft2>
