import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AlertCircleAccent from '../icons-test/alert-circle-accent'
    
    const meta: Meta<typeof AlertCircleAccent> = {
        component: AlertCircleAccent,
        title: 'accent/AlertCircleAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AlertCircleAccent>
