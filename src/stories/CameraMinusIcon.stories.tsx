import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CameraMinusIcon from '../icons/camera-minus-icon'
    
    const meta: Meta<typeof CameraMinusIcon> = {
        component: CameraMinusIcon,
        title: 'outline/CameraMinusIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CameraMinusIcon>
