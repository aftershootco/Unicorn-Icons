import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CurrencyDollar from '../icons-test/currency-dollar'
    
    const meta: Meta<typeof CurrencyDollar> = {
        component: CurrencyDollar,
        title: 'outline/CurrencyDollar',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CurrencyDollar>
