import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AftershootCreditIcon from '../icons/aftershoot-credit-icon'
    
    const meta: Meta<typeof AftershootCreditIcon> = {
        component: AftershootCreditIcon,
        title: 'logo/AftershootCreditIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AftershootCreditIcon>
