import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AftershootCredit from '../icons-test/aftershoot-credit'
    
    const meta: Meta<typeof AftershootCredit> = {
        component: AftershootCredit,
        title: 'logo/AftershootCredit',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AftershootCredit>
