import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DeviceTvIcon from '../icons/device-tv-icon'
    
    const meta: Meta<typeof DeviceTvIcon> = {
        component: DeviceTvIcon,
        title: 'outline/DeviceTvIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DeviceTvIcon>
