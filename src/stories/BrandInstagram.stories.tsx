import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandInstagram from '../icons-test/brand-instagram'
    
    const meta: Meta<typeof BrandInstagram> = {
        component: BrandInstagram,
        title: 'outline/BrandInstagram',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandInstagram>
