import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandFacebook from '../icons-test/brand-facebook'
    
    const meta: Meta<typeof BrandFacebook> = {
        component: BrandFacebook,
        title: 'outline/BrandFacebook',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandFacebook>
