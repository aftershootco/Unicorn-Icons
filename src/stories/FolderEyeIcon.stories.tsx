import type { Meta, StoryObj } from '@storybook/react'
    ...
    import FolderEyeIcon from '../icons/folder-eye-icon'
    
    const meta: Meta<typeof FolderEyeIcon> = {
        component: FolderEyeIcon,
        title: 'outline/FolderEyeIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof FolderEyeIcon>
