import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandTwitterIcon from '../icons/brand-twitter-icon'
    
    const meta: Meta<typeof BrandTwitterIcon> = {
        component: BrandTwitterIcon,
        title: 'outline/BrandTwitterIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandTwitterIcon>
