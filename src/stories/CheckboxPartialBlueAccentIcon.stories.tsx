import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CheckboxPartialBlueAccentIcon from '../icons/checkbox-partial-blue-accent-icon'
    
    const meta: Meta<typeof CheckboxPartialBlueAccentIcon> = {
        component: CheckboxPartialBlueAccentIcon,
        title: 'accent/CheckboxPartialBlueAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CheckboxPartialBlueAccentIcon>
