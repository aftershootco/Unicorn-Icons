import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AtomAccent from '../icons-test/atom-accent'
    
    const meta: Meta<typeof AtomAccent> = {
        component: AtomAccent,
        title: 'accent/AtomAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AtomAccent>
