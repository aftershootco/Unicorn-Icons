import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DeviceLaptop from '../icons-test/device-laptop'
    
    const meta: Meta<typeof DeviceLaptop> = {
        component: DeviceLaptop,
        title: 'outline/DeviceLaptop',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DeviceLaptop>
