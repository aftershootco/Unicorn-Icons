import type { Meta, StoryObj } from '@storybook/react'
    ...
    import FolderDownload from '../icons-test/folder-download'
    
    const meta: Meta<typeof FolderDownload> = {
        component: FolderDownload,
        title: 'outline/FolderDownload',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof FolderDownload>
