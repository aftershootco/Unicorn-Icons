import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandFacebookIcon from '../icons/brand-facebook-icon'
    
    const meta: Meta<typeof BrandFacebookIcon> = {
        component: BrandFacebookIcon,
        title: 'outline/BrandFacebookIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandFacebookIcon>
