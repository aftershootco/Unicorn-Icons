import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CircleCrossAccentIcon from '../icons/circle-cross-accent-icon'
    
    const meta: Meta<typeof CircleCrossAccentIcon> = {
        component: CircleCrossAccentIcon,
        title: 'accent/CircleCrossAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CircleCrossAccentIcon>
