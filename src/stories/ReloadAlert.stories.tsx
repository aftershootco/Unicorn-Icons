import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ReloadAlert from '../icons-test/reload-alert'
    
    const meta: Meta<typeof ReloadAlert> = {
        component: ReloadAlert,
        title: 'outline/ReloadAlert',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ReloadAlert>
