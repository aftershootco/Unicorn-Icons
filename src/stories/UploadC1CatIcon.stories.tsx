import type { Meta, StoryObj } from '@storybook/react'
    ...
    import UploadC1CatIcon from '../icons/upload-c1-cat-icon'
    
    const meta: Meta<typeof UploadC1CatIcon> = {
        component: UploadC1CatIcon,
        title: 'mix/UploadC1CatIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof UploadC1CatIcon>
