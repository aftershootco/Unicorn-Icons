import type { Meta, StoryObj } from '@storybook/react'
    ...
    import MoodCrazyHappyIcon from '../icons/mood-crazy-happy-icon'
    
    const meta: Meta<typeof MoodCrazyHappyIcon> = {
        component: MoodCrazyHappyIcon,
    ...
    export default meta
    type Story = StoryObj<typeof MoodCrazyHappyIcon>
