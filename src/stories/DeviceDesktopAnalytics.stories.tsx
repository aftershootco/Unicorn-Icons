import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DeviceDesktopAnalytics from '../icons-test/device-desktop-analytics'
    
    const meta: Meta<typeof DeviceDesktopAnalytics> = {
        component: DeviceDesktopAnalytics,
        title: 'outline/DeviceDesktopAnalytics',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DeviceDesktopAnalytics>
