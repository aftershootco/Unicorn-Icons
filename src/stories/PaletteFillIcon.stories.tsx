import type { Meta, StoryObj } from '@storybook/react'
    ...
    import PaletteFillIcon from '../icons/palette-fill-icon'
    
    const meta: Meta<typeof PaletteFillIcon> = {
        component: PaletteFillIcon,
        title: 'fill/PaletteFillIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof PaletteFillIcon>
