import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ArrowsDiagonal from '../icons-test/arrows-diagonal'
    
    const meta: Meta<typeof ArrowsDiagonal> = {
        component: ArrowsDiagonal,
        title: 'outline/ArrowsDiagonal',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowsDiagonal>
