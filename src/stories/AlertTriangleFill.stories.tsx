import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AlertTriangleFill from '../icons-test/alert-triangle-fill'
    
    const meta: Meta<typeof AlertTriangleFill> = {
        component: AlertTriangleFill,
        title: 'accent/AlertTriangleFill',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AlertTriangleFill>
