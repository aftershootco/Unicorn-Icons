import type { Meta, StoryObj } from '@storybook/react'
    ...
    import InfoCirlce2Icon from '../icons/info-cirlce-2-icon'
    
    const meta: Meta<typeof InfoCirlce2Icon> = {
        component: InfoCirlce2Icon,
        title: 'outline/InfoCirlce2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof InfoCirlce2Icon>
