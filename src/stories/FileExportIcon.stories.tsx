import type { Meta, StoryObj } from '@storybook/react'
    ...
    import FileExportIcon from '../icons/file-export-icon'
    
    const meta: Meta<typeof FileExportIcon> = {
        component: FileExportIcon,
        title: 'outline/FileExportIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof FileExportIcon>
