import type { Meta, StoryObj } from '@storybook/react'
    ...
    import UploadAccent from '../icons-test/upload-accent'
    
    const meta: Meta<typeof UploadAccent> = {
        component: UploadAccent,
        title: 'accent/UploadAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof UploadAccent>
