import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DeviceDesktop from '../icons-test/device-desktop'
    
    const meta: Meta<typeof DeviceDesktop> = {
        component: DeviceDesktop,
        title: 'outline/DeviceDesktop',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DeviceDesktop>
