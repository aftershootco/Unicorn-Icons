import type { Meta, StoryObj } from '@storybook/react'
    ...
    import StackTripleIcon from '../icons/stack-triple-icon'
    
    const meta: Meta<typeof StackTripleIcon> = {
        component: StackTripleIcon,
        title: 'outline/StackTripleIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof StackTripleIcon>
