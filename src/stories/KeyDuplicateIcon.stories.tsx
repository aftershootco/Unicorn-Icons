import type { Meta, StoryObj } from '@storybook/react'
    ...
    import KeyDuplicateIcon from '../icons/key-duplicate-icon'
    
    const meta: Meta<typeof KeyDuplicateIcon> = {
        component: KeyDuplicateIcon,
        title: 'outline/KeyDuplicateIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof KeyDuplicateIcon>
