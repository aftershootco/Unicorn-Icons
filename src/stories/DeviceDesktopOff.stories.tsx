import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DeviceDesktopOff from '../icons-test/device-desktop-off'
    
    const meta: Meta<typeof DeviceDesktopOff> = {
        component: DeviceDesktopOff,
        title: 'outline/DeviceDesktopOff',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DeviceDesktopOff>
