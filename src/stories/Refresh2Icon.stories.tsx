import type { Meta, StoryObj } from '@storybook/react'
    ...
    import Refresh2Icon from '../icons/refresh-2-icon'
    
    const meta: Meta<typeof Refresh2Icon> = {
        component: Refresh2Icon,
        title: 'outline/Refresh2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof Refresh2Icon>
