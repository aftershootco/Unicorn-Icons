import type { Meta, StoryObj } from '@storybook/react'
    ...
    import UploadC1Cat from '../icons-test/upload-c1-cat'
    
    const meta: Meta<typeof UploadC1Cat> = {
        component: UploadC1Cat,
        title: 'mix/UploadC1Cat',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof UploadC1Cat>
