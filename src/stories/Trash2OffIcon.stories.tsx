import type { Meta, StoryObj } from '@storybook/react'
    ...
    import Trash2OffIcon from '../icons/trash-2-off-icon'
    
    const meta: Meta<typeof Trash2OffIcon> = {
        component: Trash2OffIcon,
        title: 'outline/Trash2OffIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof Trash2OffIcon>
