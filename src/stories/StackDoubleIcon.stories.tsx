import type { Meta, StoryObj } from '@storybook/react'
    ...
    import StackDoubleIcon from '../icons/stack-double-icon'
    
    const meta: Meta<typeof StackDoubleIcon> = {
        component: StackDoubleIcon,
        title: 'outline/StackDoubleIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof StackDoubleIcon>
