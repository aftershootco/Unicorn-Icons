import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ZoomQuestionIcon from '../icons/zoom-question-icon'
    
    const meta: Meta<typeof ZoomQuestionIcon> = {
        component: ZoomQuestionIcon,
        title: 'outline/ZoomQuestionIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ZoomQuestionIcon>
