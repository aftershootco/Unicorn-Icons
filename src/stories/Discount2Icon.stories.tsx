import type { Meta, StoryObj } from '@storybook/react'
    ...
    import Discount2Icon from '../icons/discount-2-icon'
    
    const meta: Meta<typeof Discount2Icon> = {
        component: Discount2Icon,
        title: 'outline/Discount2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof Discount2Icon>
