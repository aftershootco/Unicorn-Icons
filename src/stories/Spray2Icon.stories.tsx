import type { Meta, StoryObj } from '@storybook/react'
    ...
    import Spray2Icon from '../icons/spray_2-icon'
    
    const meta: Meta<typeof Spray2Icon> = {
        component: Spray2Icon,
        title: 'outline/Spray2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof Spray2Icon>
