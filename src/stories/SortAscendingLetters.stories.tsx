import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortAscendingLetters from '../icons-test/sort-ascending-letters'
    
    const meta: Meta<typeof SortAscendingLetters> = {
        component: SortAscendingLetters,
        title: 'outline/SortAscendingLetters',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortAscendingLetters>
