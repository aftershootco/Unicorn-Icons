import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CameraPlusIcon from '../icons/camera-plus-icon'
    
    const meta: Meta<typeof CameraPlusIcon> = {
        component: CameraPlusIcon,
        title: 'outline/CameraPlusIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CameraPlusIcon>
