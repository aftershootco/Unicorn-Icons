import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortAscendingNumbers from '../icons-test/sort-ascending-numbers'
    
    const meta: Meta<typeof SortAscendingNumbers> = {
        component: SortAscendingNumbers,
        title: 'outline/SortAscendingNumbers',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortAscendingNumbers>
