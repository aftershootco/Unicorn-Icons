import type { Meta, StoryObj } from '@storybook/react'
    ...
    import GridView1Icon from '../icons/grid-view-1-icon'
    
    const meta: Meta<typeof GridView1Icon> = {
        component: GridView1Icon,
        title: 'fill/GridView1Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof GridView1Icon>
