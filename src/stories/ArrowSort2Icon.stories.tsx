import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ArrowSort2Icon from '../icons/arrow-sort-2-icon'
    
    const meta: Meta<typeof ArrowSort2Icon> = {
        component: ArrowSort2Icon,
        title: 'outline/ArrowSort2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowSort2Icon>
