import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CircleMinusIcon from '../icons/circle-minus-icon'
    
    const meta: Meta<typeof CircleMinusIcon> = {
        component: CircleMinusIcon,
        title: 'outline/CircleMinusIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CircleMinusIcon>
