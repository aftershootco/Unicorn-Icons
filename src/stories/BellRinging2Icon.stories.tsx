import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BellRinging2Icon from '../icons/bell-ringing-2-icon'
    
    const meta: Meta<typeof BellRinging2Icon> = {
        component: BellRinging2Icon,
        title: 'outline/BellRinging2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BellRinging2Icon>
