import type { Meta, StoryObj } from '@storybook/react'
    ...
    import PaletteFill from '../icons-test/palette-fill'
    
    const meta: Meta<typeof PaletteFill> = {
        component: PaletteFill,
        title: 'omega/PaletteFill',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof PaletteFill>
