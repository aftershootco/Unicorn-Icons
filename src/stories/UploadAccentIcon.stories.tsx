import type { Meta, StoryObj } from '@storybook/react'
    ...
    import UploadAccentIcon from '../icons/upload-accent-icon'
    
    const meta: Meta<typeof UploadAccentIcon> = {
        component: UploadAccentIcon,
        title: 'accent/UploadAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof UploadAccentIcon>
