import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ReloadAlertIcon from '../icons/reload-alert-icon'
    
    const meta: Meta<typeof ReloadAlertIcon> = {
        component: ReloadAlertIcon,
        title: 'outline/ReloadAlertIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ReloadAlertIcon>
