import type { Meta, StoryObj } from '@storybook/react'
    ...
    import LockOffIcon from '../icons/lock-off-icon'
    
    const meta: Meta<typeof LockOffIcon> = {
        component: LockOffIcon,
        title: 'outline/LockOffIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof LockOffIcon>
