import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CurrentLocationIcon from '../icons/current-location-icon'
    
    const meta: Meta<typeof CurrentLocationIcon> = {
        component: CurrentLocationIcon,
        title: 'outline/CurrentLocationIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CurrentLocationIcon>
