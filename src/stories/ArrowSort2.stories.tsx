import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ArrowSort2 from '../icons-test/arrow-sort-2'
    
    const meta: Meta<typeof ArrowSort2> = {
        component: ArrowSort2,
        title: 'outline/ArrowSort2',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowSort2>
