import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortAscendingLettersIcon from '../icons/sort-ascending-letters-icon'
    
    const meta: Meta<typeof SortAscendingLettersIcon> = {
        component: SortAscendingLettersIcon,
        title: 'outline/SortAscendingLettersIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortAscendingLettersIcon>
