import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SuccessDiIcon from '../icons/success-di-icon'
    
    const meta: Meta<typeof SuccessDiIcon> = {
        component: SuccessDiIcon,
        title: 'accent/SuccessDiIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SuccessDiIcon>
