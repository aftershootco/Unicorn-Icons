import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ArrowRightFillIcon from '../icons/arrow-right-fill-icon'
    
    const meta: Meta<typeof ArrowRightFillIcon> = {
        component: ArrowRightFillIcon,
        title: 'fill/ArrowRightFillIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowRightFillIcon>
