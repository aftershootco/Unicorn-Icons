import type { Meta, StoryObj } from '@storybook/react'
    ...
    import FileReportIcon from '../icons/file-report-icon'
    
    const meta: Meta<typeof FileReportIcon> = {
        component: FileReportIcon,
        title: 'outline/FileReportIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof FileReportIcon>
