import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CircleCheck2 from '../icons-test/circle-check-2'
    
    const meta: Meta<typeof CircleCheck2> = {
        component: CircleCheck2,
        title: 'outline/CircleCheck2',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CircleCheck2>
