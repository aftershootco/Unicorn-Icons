import type { Meta, StoryObj } from '@storybook/react'
    ...
    import Crown2Fill from '../icons-test/crown-2-fill'
    
    const meta: Meta<typeof Crown2Fill> = {
        component: Crown2Fill,
        title: 'omega/Crown2Fill',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof Crown2Fill>
