import type { Meta, StoryObj } from '@storybook/react'
    ...
    import InfoCirlce2 from '../icons-test/info-cirlce-2'
    
    const meta: Meta<typeof InfoCirlce2> = {
        component: InfoCirlce2,
        title: 'outline/InfoCirlce2',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof InfoCirlce2>
