import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CloudUploadAccent from '../icons-test/cloud-upload-accent'
    
    const meta: Meta<typeof CloudUploadAccent> = {
        component: CloudUploadAccent,
    ...
    export default meta
    type Story = StoryObj<typeof CloudUploadAccent>
