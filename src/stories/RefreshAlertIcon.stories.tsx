import type { Meta, StoryObj } from '@storybook/react'
    ...
    import RefreshAlertIcon from '../icons/refresh-alert-icon'
    
    const meta: Meta<typeof RefreshAlertIcon> = {
        component: RefreshAlertIcon,
        title: 'outline/RefreshAlertIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof RefreshAlertIcon>
