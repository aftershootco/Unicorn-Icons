import type { Meta, StoryObj } from '@storybook/react'
    ...
    import RotateSquareRightIcon from '../icons/rotate-square-right-icon'
    
    const meta: Meta<typeof RotateSquareRightIcon> = {
        component: RotateSquareRightIcon,
        title: 'outline/RotateSquareRightIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof RotateSquareRightIcon>
