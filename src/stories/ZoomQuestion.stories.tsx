import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ZoomQuestion from '../icons-test/zoom-question'
    
    const meta: Meta<typeof ZoomQuestion> = {
        component: ZoomQuestion,
        title: 'outline/ZoomQuestion',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ZoomQuestion>
