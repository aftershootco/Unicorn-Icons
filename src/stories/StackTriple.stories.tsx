import type { Meta, StoryObj } from '@storybook/react'
    ...
    import StackTriple from '../icons-test/stack-triple'
    
    const meta: Meta<typeof StackTriple> = {
        component: StackTriple,
        title: 'outline/StackTriple',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof StackTriple>
