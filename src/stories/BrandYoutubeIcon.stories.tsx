import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandYoutubeIcon from '../icons/brand-youtube-icon'
    
    const meta: Meta<typeof BrandYoutubeIcon> = {
        component: BrandYoutubeIcon,
        title: 'outline/BrandYoutubeIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandYoutubeIcon>
