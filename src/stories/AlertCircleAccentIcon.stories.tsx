import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AlertCircleAccentIcon from '../icons/alert-circle-accent-icon'
    
    const meta: Meta<typeof AlertCircleAccentIcon> = {
        component: AlertCircleAccentIcon,
        title: 'accent/AlertCircleAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AlertCircleAccentIcon>
