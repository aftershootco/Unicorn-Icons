import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ShoppingCartDiscount from '../icons-test/shopping-cart-discount'
    
    const meta: Meta<typeof ShoppingCartDiscount> = {
        component: ShoppingCartDiscount,
        title: 'outline/ShoppingCartDiscount',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ShoppingCartDiscount>
