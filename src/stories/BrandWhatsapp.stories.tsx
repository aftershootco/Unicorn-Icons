import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BrandWhatsapp from '../icons-test/brand-whatsapp'
    
    const meta: Meta<typeof BrandWhatsapp> = {
        component: BrandWhatsapp,
        title: 'outline/BrandWhatsapp',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BrandWhatsapp>
