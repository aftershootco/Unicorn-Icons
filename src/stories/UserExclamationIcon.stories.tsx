import type { Meta, StoryObj } from '@storybook/react'
    ...
    import UserExclamationIcon from '../icons/user-exclamation-icon'
    
    const meta: Meta<typeof UserExclamationIcon> = {
        component: UserExclamationIcon,
        title: 'outline/UserExclamationIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof UserExclamationIcon>
