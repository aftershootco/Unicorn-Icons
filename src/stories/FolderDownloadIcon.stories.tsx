import type { Meta, StoryObj } from '@storybook/react'
    ...
    import FolderDownloadIcon from '../icons/folder-download-icon'
    
    const meta: Meta<typeof FolderDownloadIcon> = {
        component: FolderDownloadIcon,
        title: 'outline/FolderDownloadIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof FolderDownloadIcon>
