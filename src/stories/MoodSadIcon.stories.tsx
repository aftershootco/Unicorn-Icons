import type { Meta, StoryObj } from '@storybook/react'
    ...
    import MoodSadIcon from '../icons/mood-sad-icon'
    
    const meta: Meta<typeof MoodSadIcon> = {
        component: MoodSadIcon,
        title: 'outline/MoodSadIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof MoodSadIcon>
