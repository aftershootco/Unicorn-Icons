import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ArrowCurveFill from '../icons-test/arrow-curve-fill'
    
    const meta: Meta<typeof ArrowCurveFill> = {
        component: ArrowCurveFill,
        title: 'omega/ArrowCurveFill',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ArrowCurveFill>
