import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortDescending2Icon from '../icons/sort-descending-2-icon'
    
    const meta: Meta<typeof SortDescending2Icon> = {
        component: SortDescending2Icon,
        title: 'outline/SortDescending2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortDescending2Icon>
