import type { Meta, StoryObj } from '@storybook/react'
    ...
    import BellMinusIcon from '../icons/bell-minus-icon'
    
    const meta: Meta<typeof BellMinusIcon> = {
        component: BellMinusIcon,
        title: 'outline/BellMinusIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof BellMinusIcon>
