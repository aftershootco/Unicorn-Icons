import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AlertTriangleAccentIcon from '../icons/alert-triangle-accent-icon'
    
    const meta: Meta<typeof AlertTriangleAccentIcon> = {
        component: AlertTriangleAccentIcon,
        title: 'accent/AlertTriangleAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AlertTriangleAccentIcon>
