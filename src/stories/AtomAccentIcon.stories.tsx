import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AtomAccentIcon from '../icons/atom-accent-icon'
    
    const meta: Meta<typeof AtomAccentIcon> = {
        component: AtomAccentIcon,
        title: 'accent/AtomAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AtomAccentIcon>
