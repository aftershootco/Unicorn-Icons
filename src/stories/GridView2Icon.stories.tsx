import type { Meta, StoryObj } from '@storybook/react'
    ...
    import GridView2Icon from '../icons/grid-view-2-icon'
    
    const meta: Meta<typeof GridView2Icon> = {
        component: GridView2Icon,
        title: 'fill/GridView2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof GridView2Icon>
