import type { Meta, StoryObj } from '@storybook/react'
    ...
    import MoodSmileIcon from '../icons/mood-smile-icon'
    
    const meta: Meta<typeof MoodSmileIcon> = {
        component: MoodSmileIcon,
        title: 'outline/MoodSmileIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof MoodSmileIcon>
