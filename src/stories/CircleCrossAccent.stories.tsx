import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CircleCrossAccent from '../icons-test/circle-cross-accent'
    
    const meta: Meta<typeof CircleCrossAccent> = {
        component: CircleCrossAccent,
        title: 'accent/CircleCrossAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CircleCrossAccent>
