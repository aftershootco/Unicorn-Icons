import type { Meta, StoryObj } from '@storybook/react'
    ...
    import UserOffIcon from '../icons/user-off-icon'
    
    const meta: Meta<typeof UserOffIcon> = {
        component: UserOffIcon,
        title: 'outline/UserOffIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof UserOffIcon>
