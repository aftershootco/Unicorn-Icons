import type { Meta, StoryObj } from '@storybook/react'
    ...
    import MouseLeft2Icon from '../icons/mouse-left-2-icon'
    
    const meta: Meta<typeof MouseLeft2Icon> = {
        component: MouseLeft2Icon,
        title: 'no-change/MouseLeft2Icon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof MouseLeft2Icon>
