import type { Meta, StoryObj } from '@storybook/react'
    ...
    import AlertTriangleAccent from '../icons-test/alert-triangle-accent'
    
    const meta: Meta<typeof AlertTriangleAccent> = {
        component: AlertTriangleAccent,
        title: 'accent/AlertTriangleAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof AlertTriangleAccent>
