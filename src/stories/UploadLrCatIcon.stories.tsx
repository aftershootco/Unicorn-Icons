import type { Meta, StoryObj } from '@storybook/react'
    ...
    import UploadLrCatIcon from '../icons/upload-lr-cat-icon'
    
    const meta: Meta<typeof UploadLrCatIcon> = {
        component: UploadLrCatIcon,
        title: 'mix/UploadLrCatIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof UploadLrCatIcon>
