import type { Meta, StoryObj } from '@storybook/react'
    ...
    import SortAscendingNumbersIcon from '../icons/sort-ascending-numbers-icon'
    
    const meta: Meta<typeof SortAscendingNumbersIcon> = {
        component: SortAscendingNumbersIcon,
        title: 'outline/SortAscendingNumbersIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof SortAscendingNumbersIcon>
