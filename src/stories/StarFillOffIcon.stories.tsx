import type { Meta, StoryObj } from '@storybook/react'
    ...
    import StarFillOffIcon from '../icons/star-fill-off-icon'
    
    const meta: Meta<typeof StarFillOffIcon> = {
        component: StarFillOffIcon,
        title: 'no-change/StarFillOffIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof StarFillOffIcon>
