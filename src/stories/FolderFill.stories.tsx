import type { Meta, StoryObj } from '@storybook/react'
    ...
    import FolderFill from '../icons-test/folder-fill'
    
    const meta: Meta<typeof FolderFill> = {
        component: FolderFill,
        title: 'no-change/FolderFill',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof FolderFill>
