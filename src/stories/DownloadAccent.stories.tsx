import type { Meta, StoryObj } from '@storybook/react'
    ...
    import DownloadAccent from '../icons-test/download-accent'
    
    const meta: Meta<typeof DownloadAccent> = {
        component: DownloadAccent,
        title: 'accent/DownloadAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof DownloadAccent>
