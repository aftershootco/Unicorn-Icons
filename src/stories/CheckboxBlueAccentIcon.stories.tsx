import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CheckboxBlueAccentIcon from '../icons/checkbox-blue-accent-icon'
    
    const meta: Meta<typeof CheckboxBlueAccentIcon> = {
        component: CheckboxBlueAccentIcon,
        title: 'accent/CheckboxBlueAccentIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CheckboxBlueAccentIcon>
