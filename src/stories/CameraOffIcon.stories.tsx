import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CameraOffIcon from '../icons/camera-off-icon'
    
    const meta: Meta<typeof CameraOffIcon> = {
        component: CameraOffIcon,
        title: 'outline/CameraOffIcon',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CameraOffIcon>
