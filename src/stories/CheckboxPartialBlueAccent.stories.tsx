import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CheckboxPartialBlueAccent from '../icons-test/checkbox-partial-blue-accent'
    
    const meta: Meta<typeof CheckboxPartialBlueAccent> = {
        component: CheckboxPartialBlueAccent,
        title: 'accent/CheckboxPartialBlueAccent',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CheckboxPartialBlueAccent>
