...
export const DeleteBgIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	const {
		variant = 'primary',
	...
	// variants
	const primary = (
		<svg viewBox='0 0 97 96' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} ref={forwardedRef} {...restProps}>
			<rect x='0.5' width='96' height='96' rx='48' fill={bgColor} fillOpacity='0.3' />
			<g clipPath='url(#clip0_13360_17518)'>
				<path d='M27.1667 34.6665H69.8334' stroke={modifiedColor} stroke-width='2' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M43.1667 45.3335V61.3335' stroke={modifiedColor} stroke-width='2' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M53.8333 45.3335V61.3335' stroke={modifiedColor} stroke-width='2' strokeLinecap='round' strokeLinejoin='round' />
				<path
