...
export const ArrowCurveIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	...
	// variants
	const primary = (
		<svg viewBox='0 0 16 11' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} {...restProps} ref={forwardedRef}>
			<path
...
export default React.memo(ArrowCurveIcon)
