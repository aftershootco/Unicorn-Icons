...
export const AlertTriangleIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	...
	// variants
	const primary = (
		<svg viewBox='0 0 58 52' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} {...restProps} ref={forwardedRef}>
			<path d='M29 38V38.03M29 20V26V20Z' stroke={modifiedColor} stroke-width='3' strokeLinecap='round' strokeLinejoin='round' />
			<path
	...
	const secondary = (
		<svg viewBox='0 0 13 13' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} {...restProps} ref={forwardedRef}>
			<path
				...
				strokeLinejoin='round'
			/>
			<path d='M6.5332 7.70016V7.70516M6.5332 4.7002V5.70018V4.7002Z' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
		</svg>
	)
