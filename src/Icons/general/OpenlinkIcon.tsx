	...
	const secondary = (
		<svg viewBox='0 0 16 17' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} ref={forwardedRef} {...restProps}>
			<g clipPath='url(#clip0_21395_124739)'>
				...
				/>
				<path d='M6.66675 9.55436L13.3334 2.8877' stroke={color} strokeLinecap='round' strokeLinejoin='round' />
				<path d='M10 2.8877H13.3333V6.22103' stroke={color} strokeLinecap='round' strokeLinejoin='round' />
			</g>
			<defs>
