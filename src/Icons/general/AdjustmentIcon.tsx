...
export const AdjustmentIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	...
	const primary = (
		<svg viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} {...restProps} ref={forwardedRef}>
			<g clipPath='url(#clip0_5641_27511)'>
				<path
				...
				/>
				<path d='M3.33301 5H9.99967' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
				<path d='M13.333 5H16.6663' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
				<path
					...
					strokeLinejoin='round'
				/>
				<path d='M3.33301 10H4.99967' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
				<path d='M8.33301 10H16.6663' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
				<path
					...
					strokeLinejoin='round'
				/>
				<path d='M3.33301 15H12.4997' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
				<path d='M15.833 15H16.6663' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
			</g>
			<defs>
