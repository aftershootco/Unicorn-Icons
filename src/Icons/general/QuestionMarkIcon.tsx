...
export const QuestionMarkIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	...
	const primary = (
		<svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' style={{ width: iconSize }} ref={forwardedRef} {...restProps}>
	...
	const secondary = (
		<svg viewBox='0 0 10 14' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} ref={forwardedRef} {...restProps}>
			<path
			...
			/>
			<path d='M5 12.8333V12.8417' stroke={modifiedColor} stroke-width='2' strokeLinecap='square' strokeLinejoin='bevel' />
		</svg>
	)
