...
export const AlertHexagonBgIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	const {
		variant = 'primary',
	...
	const primary = (
		<svg viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} {...restProps} ref={forwardedRef}>
			<g filter='url(#filter0_b_14013_43614)'>
				...
				<g clipPath='url(#clip0_14013_43614)'>
					<path
					...
					/>
					<path d='M10 8V10' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
					<path d='M10 12H10.005' stroke={modifiedColor} strokeLinecap='round' strokeLinejoin='round' />
				</g>
			</g>
			<defs>
				<filter
