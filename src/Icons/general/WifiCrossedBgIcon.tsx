...
export const WifiCrossedBgIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	...
	// variants
	const primary = (
		<svg viewBox='0 0 96 96' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} ref={forwardedRef} {...restProps}>
			<rect width='96' height='96' rx='48' fill={bgColor} fillOpacity={bgOpacity} />
			<g clipPath='url(#clip0_18341_4857)'>
				<path d='M48 64H48.0267' stroke={modifiedColor} stroke-width='3' strokeLinecap='round' strokeLinejoin='round' />
				<path
				...
				<path
					...
					strokeLinejoin='round'
				/>
				<path d='M24 24L72 72' stroke={modifiedColor} stroke-width='2' strokeLinecap='round' strokeLinejoin='round' />
			</g>
			<defs>
