...
export const ScissorsIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	...
	// variants
	const primary = (
		<svg viewBox='0 0 20 18' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} {...restProps} ref={forwardedRef}>
			<mask
				id='mask0_2964_1117'
				style={{
					maskType: 'alpha',
