...
const ImageNotFound: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg width='97' height='96' viewBox='0 0 97 96' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			...
			<g clipPath='url(#clip0_13360_25254)'>
				<path d='M24.5 24L72.5 72' stroke='#D83D3D' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M56.5 37.333H56.5267' stroke='#D83D3D' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round' />
				<path
