...
const NetworkErrorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg width='97' height='96' viewBox='0 0 97 96' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			...
			<g clipPath='url(#clip0_13784_24779)'>
				<path d='M48.5 64H48.5267' stroke='#D83D3D' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round' />
				<path
				...
				<path
					...
					strokeLinejoin='round'
				/>
				<path d='M24.5 24L72.5 72' stroke='#D83D3D' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
			</g>
			<defs>
