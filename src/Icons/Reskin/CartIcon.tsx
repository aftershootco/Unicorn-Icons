		...
		<svg {...props} width='36' height='36' viewBox='0 0 36 36' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<g clipPath='url(#clip0_11945_21255)'>
				...
				<path
					...
					strokeLinejoin='round'
				/>
				<path d='M25.5 25.5H9V4.5H6' stroke='#2279CE' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M30 9L28.5 19.5H9' stroke='#2279CE' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M15 15L24 6' stroke='#2279CE' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
				<path
