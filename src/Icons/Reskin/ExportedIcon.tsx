...
const ExportedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg width='15' height='18' viewBox='0 0 15 18' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			<g clipPath='url(#clip0_13900_1702)'>
				...
				/>
				<path d='M3.55359 5.94657L7.57145 1.92871L11.5893 5.94657' stroke='#ABABAB' strokeLinejoin='round' />
				<path d='M7.57141 1.92871V11.5716' stroke='#ABABAB' strokeLinejoin='round' />
			</g>
			<defs>
