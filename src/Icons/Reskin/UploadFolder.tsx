...
const UploadFolder: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg width='24' height='21' viewBox='0 0 24 21' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			...
			/>
			<path d='M12 15.6667V9.83335' stroke='#777777' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
			<path d='M8.5 13.3334L12 9.83337L15.5 13.3334' stroke='#777777' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
		</svg>
	)
}
