...
const ErrorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
	return (
		<svg width='29' height='29' viewBox='0 0 29 29' fill='none' xmlns='http://www.w3.org/2000/svg'>
			...
			<g clipPath='url(#clip0_13276_22829)'>
				<path d='M14.3525 17.2021V17.2105M14.3525 12.2021V13.8688V12.2021Z' stroke='#E2E2E2' strokeLinecap='round' strokeLinejoin='round' />
				<path
