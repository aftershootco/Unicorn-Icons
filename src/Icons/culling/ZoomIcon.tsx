...
export const ZoomIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	...
	const secondary = (
		<svg viewBox='0 0 22 22' fill='none' xmlns='http://www.w3.org/2000/svg' style={{ width: iconSize }} {...restProps} ref={forwardedRef}>
			<g clipPath='url(#clip0_12138_30346)'>
				<path
					...
					strokeLinejoin='round'
				/>
				<path d='M6.41602 9.1665H11.916' stroke={modifiedColor} stroke-width='2' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M9.16602 6.4165V11.9165' stroke={modifiedColor} stroke-width='2' strokeLinecap='round' strokeLinejoin='round' />
				<path d='M19.25 19.25L13.75 13.75' stroke={modifiedColor} stroke-width='2' strokeLinecap='round' strokeLinejoin='round' />
			</g>
			<defs>
