...
export const SelectedCircleBgIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	//props
	const {
		variant = 'primary',
		color = DEFAULT_ICON.COLOR,
		bgColor = DEFAULT_ICON.BG_COLOR,
		opacity = DEFAULT_ICON.BG_OPACITY,
	...
	const primary = (
		<svg
			...
			ref={forwardedRef}
		>
			<circle cx='10' cy='10' r='10' fill={bgColor} fillOpacity={opacity} />
			<path
