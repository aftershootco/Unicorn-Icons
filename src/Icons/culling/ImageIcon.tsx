...
export const ImageIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	...
	const primary = (
		<svg
			...
			ref={forwardedRef}
		>
			<g id='photo' clip-path='url(#clip0_3554_73881)'>
				<path id='Vector' d='M37.5 20H37.525' stroke={modifiedColor} stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round' />
				<path
					id='Vector_2'
