...
const AlertCircleAccentIcon = createASIcon(
  "AlertCircleAccentIcon",
  {
    width: "21",
    height: "20",
    viewBox: "0 0 21 20",
  ...
  <g>
    <g id="alert-circle" clip-path="url(#clip0_104_75)" key="rdppu8">
      <path
        id="Vector"
...
export default AlertCircleAccentIcon;
