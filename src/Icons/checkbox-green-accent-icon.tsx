...
const CheckboxGreenAccentIcon = createASIcon(
  "CheckboxGreenAccentIcon",
  {
    width: "16",
    height: "16",
    viewBox: "0 0 16 16",
  ...
  <g>
    <rect
      ...
      key="p7gwf2"
    />
    <rect x="2" y="2" width="12" height="12" rx="1" fill="green" key="12yry4" />
    <path
      fill-rule="evenodd"
      clip-rule="evenodd"
...
export default CheckboxGreenAccentIcon;
