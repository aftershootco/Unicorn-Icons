import type { Meta, StoryObj } from '@storybook/react'
    ...
    import ChevronsRight from '../icons-omega/chevrons-right'
    
    const meta: Meta<typeof ChevronsRight> = {
        component: ChevronsRight,
        title: 'omega/ChevronsRight',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof ChevronsRight>
