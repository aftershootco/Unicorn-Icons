import type { Meta, StoryObj } from '@storybook/react'
    ...
    import CustomProfile from '../icons-neo/custom-profile'
    
    const meta: Meta<typeof CustomProfile> = {
        component: CustomProfile,
        title: 'omega/CustomProfile',
        decorators: [
            (Story) => (
    ...
    export default meta
    type Story = StoryObj<typeof CustomProfile>
