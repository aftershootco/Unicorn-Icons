...
export const LrUploadIcon = React.forwardRef<SVGSVGElement, Props>((props, forwardedRef) => {
	...
	const primary = (
		<svg
			...
			ref={forwardedRef}
		>
			<g clip-path='url(#clip0_3554_73911)'>
				<path
					fill-rule='evenodd'
					clip-rule='evenodd'
					...
					fill={modifiedColor}
				/>
				<g clip-path='url(#clip1_3554_73911)'>
					<path
					...
					/>
					<path d='M22.6172 28.501L25.1172 26.001L27.6172 28.501' stroke={accentColor} stroke-linecap='round' stroke-linejoin='round' />
					<path d='M25.1172 26.001V32.001' stroke={accentColor} stroke-linecap='round' stroke-linejoin='round' />
				</g>
			</g>
			<defs>
