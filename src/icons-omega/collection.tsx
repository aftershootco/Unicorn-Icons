  ...
  <g>
    <g clip-path="url(#a)" key="1ycjfh">
      <path
        ...
        clip-rule="evenodd"
      />
      <path d="M3.5 7.88c0-1.322 1.052-2.38 2.333-2.38h11.334c1.28 0 2.333 1.058 2.333 2.38v6.24c0 1.322-1.052 2.38-2.333 2.38H5.833c-1.28 0-2.333-1.058-2.333-2.38z" />
    </g>
    <defs key="9ahrjx">
      <clipPath id="a">
        <rect width="24" height="24" fill="#fff" transform="translate(.571)" />
      </clipPath>
    </defs>
  </g>,
);
